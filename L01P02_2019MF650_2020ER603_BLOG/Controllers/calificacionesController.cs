...
using L01P02_2019MF650_2020ER603_BLOG.Models;

namespace L01P02_2019MF650_2020ER603_BLOG.Controllers
{
    public class calificacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("calificacionId,publicacionId,calificacion,usuarioId")] calificaciones calificaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("calificacionId,publicacionId,calificacion,usuarioId")] calificaciones calificaciones)
        {
